      ...
      <div className="mx-auto max-w-7xl px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="mt-4 pt-4 border-t border-red-600">
            <h4 className="font-semibold mb-2 text-yellow-200">Return / Exchange</h4>
            <p className="text-xs text-red-100">
              For return or exchange queries, please contact us via WhatsApp or call us at {content.contact.phone}
            </p>
          </div>
        </div>
